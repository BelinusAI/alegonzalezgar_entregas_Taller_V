...
//	uint8_t pixel = 0b1100011;
//	uint8_t counter = 1;
//	while(counter < 7){
//		DrawPixel(x, y++, pixel & counter);
//		counter++;
...
//void I2C_DrawString(char* str, uint8_t x, uint8_t y, const FONT_INFO font, uint8_t color){
...
//	uint16_t font_height_bits = font[0][1];
...
//			{
//				DrawLineHorizontal(x_offset, x_offset + 7, y_offset, color);
//				y_offset += 1;
//			}
//			x_offset += 8;
//		}
