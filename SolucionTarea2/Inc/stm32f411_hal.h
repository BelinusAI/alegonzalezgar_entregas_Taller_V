 ...
 * 	- Distribución básica de la memoria (figura 14 hoja de datos)
 * 	- Posiciones de memoria de los periféricos disponibles (tabla 1 Memory Map)
 * 	- Registros de los perifericos
 * 	- Definiciones de las constantes básicas
 */

#ifndef STM32F411_HAL_H_
#define STM32F411_HAL_H_
...
/*
 * AHBx and APBx Bus Periphelas base addresses
 */
...
typedef struct
{
	...
	volatile uint32_t AMB1RSTR;
	volatile uint32_t AMB2RSTR;
