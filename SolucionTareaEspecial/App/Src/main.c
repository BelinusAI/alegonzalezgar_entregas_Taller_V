...
int main (void){
	...
	config_SysTick_ms(3); // Configuración SysTick
	...
	while(1){
		...
		/* Muestreo constante a 200Hz TODO */
//		if(muestreo){
...
void init_Hadware(void){
	...
	handlerSampleTimer4.TIMx_Config.TIMx_speed 				= BTIMER_SPEED_100us;
